...
import de.dafuqs.spectrum.blocks.candles.VelveteenCandleBlock;
...
public class SpectrumBlocks {
	...
	public static final Block ALLURING_CANDLE = new VelveteenCandleBlock(settings(MapColor.PURPLE, BlockSoundGroup.CANDLE,0.1F,0.1F).nonOpaque().pistonBehavior(PistonBehavior.DESTROY).luminance(VelveteenCandleBlock.STATE_TO_LUMINANCE));
	public static final Block SCENTED_CANDLE = new VelveteenCandleBlock(settings(MapColor.PURPLE, BlockSoundGroup.CANDLE,0.1F,0.1F).nonOpaque().pistonBehavior(PistonBehavior.DESTROY).luminance(VelveteenCandleBlock.STATE_TO_LUMINANCE));
	public static final Block SOPORIFIC_CANDLE = new VelveteenCandleBlock(settings(MapColor.PURPLE, BlockSoundGroup.CANDLE,0.1F,0.1F).nonOpaque().pistonBehavior(PistonBehavior.DESTROY).luminance(VelveteenCandleBlock.STATE_TO_LUMINANCE));
	...
	public static void register() {
		...
		registerBlockWithItem("alluring_candle", ALLURING_CANDLE, IS.of(), DyeColor.GREEN);
		registerBlockWithItem("scented_candle", SCENTED_CANDLE, IS.of(), DyeColor.GREEN);
		registerBlockWithItem("soporific_candle", SOPORIFIC_CANDLE, IS.of(), DyeColor.GREEN);
	...
	public static void registerClient() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(SpectrumBlocks.ALLURING_CANDLE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(SpectrumBlocks.SCENTED_CANDLE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(SpectrumBlocks.SOPORIFIC_CANDLE, RenderLayer.getCutout());
